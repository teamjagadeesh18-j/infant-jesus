...
export function WhatsAppFloat() {
  const message = encodeURIComponent("Hello! I am reaching out from Infant Jesus Matriculation Higher Secondary School (Vallalar Nagar) website to enquire about admissions.");
